...
* Copy or rename the module directory to regexmatch.
* Replace all occurances of regexmatch in files with the new name for your question type.
* Rename files that have regexmatch replacing regexmatch with the new name for your question type.
* Replace '@copyright  2024 Linus Andera (linus@linusdev.de)' with something like @copyright  2016 Marcus Green (mgreen@example.org)
